...
namespace FacilityServices.DataLayerTests.RepositoriesTests.ComponentTypeRepositoryTests
{
    ...
    {
        [TestMethod]
        public void GetComponentTypeByRoom_ThrowsException_WhenInvalidRoomIsProvided()
        {
            ...
            using (var memoryCtx = new FacilityContext(options))
            {
                ...
                Assert.ThrowsException<ArgumentNullException>(() => componentTypeRepository.GetComponentTypesByRoom(null));
            }
        }
        //[Ignore]
        [TestMethod]
        public void GetComponentTypeByRoom_Successfull()
        {
            ...
            context.SaveChanges();
            //Floor
            RoomTO room1 = new RoomTO { Name = new MultiLanguageString("Room1", "Room1", "Room1"), Floor = addedFloor1, ComponentTypes = new List<ComponentTypeTO>() { addedComponentType1, addedComponentType2 } };
            RoomTO room2= new RoomTO { Name = new MultiLanguageString("Room1", "Room1", "Room1"), Floor = addedFloor1, ComponentTypes = new List<ComponentTypeTO>() { addedComponentType1 } };
